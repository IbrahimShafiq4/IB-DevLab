...
Just CSS creativity and geometry control.`,
  ...
  and -webkit-box-reflect with minimal HTML.`,
      ...
      {
        videoSrc: './../../../../assets/video-samples/cssbattle/Four Leaf Shape.png',
        navigationState: false,
        title: 'CSS Battle – Four Leaf Shape',
        description: `CSS recreation of a four-leaf geometric shape using pure CSS.`,
        date: 'September 15, 2026',
        tags: ['HTML', 'CSS', 'CSS Battle'],
        projectUrl: '/css_battle_p13',
        isItCssBattle: true,
      },
      {
        videoSrc: '../../../../assets/video-samples/problem solving/palindrome_number.jpeg',
        navigationState: false,
        title: 'Palindrome Number',
        description: 'Check if an integer reads the same forward and backward.',
        date: 'September 15, 2026',
        tags: ['Problem Solving', 'JavaScript', 'LeetCode'],
        projectUrl: '/problem-solving/palindrome-number',
        isItProblemSolving: true,
      },
      {
        videoSrc: '../../../../assets/video-samples/problem solving/longest_common_prefix.jpg',
        navigationState: false,
        title: 'Longest Common Prefix',
        description: 'Find the longest prefix shared by all strings.',
        date: 'September 16, 2026',
        tags: ['Problem Solving', 'JavaScript', 'LeetCode'],
        projectUrl: '/problem-solving/longest-common-prefix',
        isItProblemSolving: true,
      },
      {
        videoSrc: '../../../../assets/video-samples/problem solving/valid_parentheses.jpeg',
        navigationState: false,
        title: 'Valid Parentheses',
        description: 'Check if brackets are opened and closed in the correct order.',
        date: 'September 17, 2026',
        tags: ['Problem Solving', 'JavaScript', 'LeetCode'],
        projectUrl: '/problem-solving/valid-parentheses',
        isItProblemSolving: true,
      },
      {
        videoSrc: './../../../../assets/video-samples/cssbattle/geometric-arch.png',
        navigationState: false,
        title: 'CSS Battle – Geometric Arch',
        description: `CSS recreation of a simple geometric arch using pure CSS.`,
        date: 'September 17, 2026',
        tags: ['HTML', 'CSS', 'CSS Battle'],
        projectUrl: '/css_battle_p14',
        isItCssBattle: true,
      },
      {
        videoSrc: './../../../../assets/video-samples/cssbattle/geometric-temple.png',
        navigationState: false,
        title: 'CSS Battle – Geometric Temple',
        description: `CSS recreation of a simple geometric temple using pure CSS.`,
        date: 'September 17, 2026',
        tags: ['HTML', 'CSS', 'CSS Battle'],
